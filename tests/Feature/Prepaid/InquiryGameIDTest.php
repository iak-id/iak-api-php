...
use Tests\Mock\Prepaid\InquiryGameIDMock;
use Tests\TestCase;
...
class InquiryGameIDTest extends TestCase
{
    ...
    public function inquiry_game_id_return_success_and_not_empty()
    {
        ...
        $this->assertEquals(InquiryGameIDMock::getGameIDMock(), $response);
    }
    ...
    private function setUpMock()
    {
        ...
        $this->mock->shouldReceive('sendRequest')->andReturn(InquiryGameIDMock::getGameIDMock());
    }
}